...
#include "../../../customIrcClient/ircuser.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ircUser_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 61, 5)
    ...
    "ircUser\0iconChanged\0\0slot_netwManagerFinished\0"
...
void ircUser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ircUser::*_t)() const;
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ircUser::iconChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ircUser::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ircUser.data,
      qt_meta_data_ircUser,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void ircUser::iconChanged()const
{
    QMetaObject::activate(const_cast< ircUser *>(this), &staticMetaObject, 0, 0);
}
